    ...
    return (
      <div className="container">
        ...
        <div className="intro">
          ...
          <h3>View a histogram of an NFL player's yards per attempt over the course of a season.<br />To use, simply select a player from the dropdown list in the top right.</h3>
